  ...
  ##################################################################
  Method <- "BN" # "BN" , "Kulldorf", "INLA"
  simulations <-1000# 
  k <- 2#  NA or e.g. 50/ALL 5/Wilms  for Besag Newell
  alpha.level <- 0.01#  0.01/ Besag, 0.05/ Kullforf  (NA for INLA)
  pop.upper.bound <- 0.1 # NA or 0.1 for Kulldorf
  n.simulations <- 50 # NA or 99  for Kulldorf
