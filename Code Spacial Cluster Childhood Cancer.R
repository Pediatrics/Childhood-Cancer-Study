...
###### which kind of risk-clusters is being formed (random size/shape)
RANDOMorDEFINED <- "random" 
...
####### Defined Clusters into the mastertable 
####### REMOVED FROM CODE (unpublished results)
} 
...
############# SAVE RESULTS of the Cluster detection test #########################
############# PERFORMANCE/ OPERATING CHARACTERISTICS ###################
saveWorkbook(wb, paste("Data/",Method,simulations, ALLorWILMS, RANDOMorDEFINED, Datum,"RESULTS.xlsx" ,sep = "") , overwrite = T)

############# RAW DATA FROM SIMULATION  #########################
##### NEXT LINES PRODUCE A COMPLETE RAW DATA (RANDOM CLUSTERS AND SIMULATED CASES IN ONE LIST)
##### ONLY WORKS FOR THE FULL SET OF RR AND CLUSTERSIZE LEVELS
allemitmapply <- mapply(c, list_of_RandomClusterCR, list_of_SimCasesCR, SIMPLIFY=FALSE)
names(allemitmapply) <- c("Cluster Size 1","Cluster Size 2","Cluster Size 5", "Cluster Size 10","Cluster Size 20","Cluster Size 50")
names(allemitmapply[[1]]) <- c("RR1 CLUSTER", "RR1.1 CLUSTER","RR1.2 CLUSTER","RR1.3 CLUSTER","RR1.4 CLUSTER","RR1.5 CLUSTER", "RR2 CLUSTER", "RR5 CLUSTER", "RR10 CLUSTER", "RR100 CLUSTER", "RR1 SimCases", "RR1.1 SimCases","RR1.2 SimCases","RR1.3 SimCases","RR1.4 SimCases","RR1.5 SimCases", "RR2 SimCases", "RR5 SimCases", "RR10 SimCases", "RR100 SimCases" )
names(allemitmapply[[2]]) <- c("RR1 CLUSTER", "RR1.1 CLUSTER","RR1.2 CLUSTER","RR1.3 CLUSTER","RR1.4 CLUSTER","RR1.5 CLUSTER", "RR2 CLUSTER", "RR5 CLUSTER", "RR10 CLUSTER", "RR100 CLUSTER", "RR1 SimCases", "RR1.1 SimCases","RR1.2 SimCases","RR1.3 SimCases","RR1.4 SimCases","RR1.5 SimCases", "RR2 SimCases", "RR5 SimCases", "RR10 SimCases", "RR100 SimCases" )
names(allemitmapply[[3]]) <- c("RR1 CLUSTER", "RR1.1 CLUSTER","RR1.2 CLUSTER","RR1.3 CLUSTER","RR1.4 CLUSTER","RR1.5 CLUSTER", "RR2 CLUSTER", "RR5 CLUSTER", "RR10 CLUSTER", "RR100 CLUSTER", "RR1 SimCases", "RR1.1 SimCases","RR1.2 SimCases","RR1.3 SimCases","RR1.4 SimCases","RR1.5 SimCases", "RR2 SimCases", "RR5 SimCases", "RR10 SimCases", "RR100 SimCases" )
names(allemitmapply[[4]]) <- c("RR1 CLUSTER", "RR1.1 CLUSTER","RR1.2 CLUSTER","RR1.3 CLUSTER","RR1.4 CLUSTER","RR1.5 CLUSTER", "RR2 CLUSTER", "RR5 CLUSTER", "RR10 CLUSTER", "RR100 CLUSTER", "RR1 SimCases", "RR1.1 SimCases","RR1.2 SimCases","RR1.3 SimCases","RR1.4 SimCases","RR1.5 SimCases", "RR2 SimCases", "RR5 SimCases", "RR10 SimCases", "RR100 SimCases" )
names(allemitmapply[[5]]) <- c("RR1 CLUSTER", "RR1.1 CLUSTER","RR1.2 CLUSTER","RR1.3 CLUSTER","RR1.4 CLUSTER","RR1.5 CLUSTER", "RR2 CLUSTER", "RR5 CLUSTER", "RR10 CLUSTER", "RR100 CLUSTER", "RR1 SimCases", "RR1.1 SimCases","RR1.2 SimCases","RR1.3 SimCases","RR1.4 SimCases","RR1.5 SimCases", "RR2 SimCases", "RR5 SimCases", "RR10 SimCases", "RR100 SimCases" )
names(allemitmapply[[6]]) <- c("RR1 CLUSTER", "RR1.1 CLUSTER","RR1.2 CLUSTER","RR1.3 CLUSTER","RR1.4 CLUSTER","RR1.5 CLUSTER", "RR2 CLUSTER", "RR5 CLUSTER", "RR10 CLUSTER", "RR100 CLUSTER", "RR1 SimCases", "RR1.1 SimCases","RR1.2 SimCases","RR1.3 SimCases","RR1.4 SimCases","RR1.5 SimCases", "RR2 SimCases", "RR5 SimCases", "RR10 SimCases", "RR100 SimCases" )

ChildhoodCancerSimulationData <-allemitmapply
### add line for Population
ChildhoodCancerSimulationData [[7]] <- polygons@data$Population
### add line for Expected Cases (rounded to full cases)
ChildhoodCancerSimulationData [[8]]<- round (polygons@data$Population*lambda*aggregate) 
names(ChildhoodCancerSimulationData) <- c("Cluster Size 1","Cluster Size 2","Cluster Size 5", "Cluster Size 10","Cluster Size 20","Cluster Size 50","District Population", "Expected Cases")

############# SAVE SIMULATED RESULTS to Rdata file #############
save (ChildhoodCancerSimulationData, file =paste(Method,simulations, ALLorWILMS, RANDOMorDEFINED, Datum, "SIMULATEDDATA.Rdata", sep = ""))
